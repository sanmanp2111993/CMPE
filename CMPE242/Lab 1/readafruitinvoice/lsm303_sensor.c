 ...
 * Author: ankit
 *
 * Created on March 1, 2016, 4:03 PM
 */
...
#define	CTRL_REG1_A		(0x20)	/*	control reg 1		*/
#define	CTRL_REG2_A		(0x21)	/*	control reg 2		*/
#define	CTRL_REG3_A		(0x22)	/*	control reg 3		*/
#define	CTRL_REG4_A		(0x23)	/*	control reg 4		*/
#define	CTRL_REG5_A		(0x24)	/*	control reg 5		*/
#define	CTRL_REG6_A		(0x25)	/*	control reg 6		*/
