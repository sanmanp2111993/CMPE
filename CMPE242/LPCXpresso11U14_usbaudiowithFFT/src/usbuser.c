...
void USB_SOF_Event (void) {
  /* This EP number should match with the EPs in the interface/EP 
  descriptor and USB initialization routine. */
  if (USB_ReadEP(USB_AUDIO_EP, (uint8_t *)&DataBuf[DataIn])) {
    /* Data Available */
