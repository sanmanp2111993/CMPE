...
void delay32Ms(uint8_t timer_num, uint32_t delayInMs)
{
  if (timer_num == 0)
  {
    ...
    LPC_CT32B0->MR0 = delayInMs * ((SystemCoreClock/(LPC_CT32B0->PR+1)) / 1000);
  ...
  else if (timer_num == 1)
  {
    ...
    LPC_CT32B1->MR0 = delayInMs * ((SystemCoreClock/(LPC_CT32B0->PR+1)) / 1000);
