...
void rectconstruct(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint32_t color)
{
	int16_t i;
...
void squarefunct(int16_t x, int16_t y, uint32_t color)
{
	int16_t a0,a1,a2,a3,b0,b1,b2,b3,x0,x1,x2,x3,y0,y1,y2,y3;
	...
	for(j=0;j<10;j++)
	{
	  	 a0=(0.8*(x1-x0))+x0;b0=(0.8*(y1-y0))+y0;
	  	 a1=(0.8*(x2-x1))+x1;b1=(0.8*(y2-y1))+y1;
	  	 a2=(0.8*(x3-x2))+x2;b2=(0.8*(y3-y2))+y2;
	  	 a3=(0.8*(x0-x3))+x3;b3=(0.8*(y0-y3))+y3;
	  	 ...
	  	 x0=a0;x1=a1;x2=a2;x3=a3;y0=b0;y1=b1;y2=b2;y3=b3;
	}
...
while(1)
{
	rectconstruct(0, 0, 120, 160, BLACK);

	x=rangen(0,120);
	y=rangen(0,160);
	squarefunct(x,y,WHITE);
	x=rangen(0,120);
	y=rangen(0,160);
  	squarefunct(x,y,YELLOW);
  	x=rangen(0,120);
  	y=rangen(0,160);
  	squarefunct(x,y,RED);
  	x=rangen(0,120);
  	y=rangen(0,160);
  	squarefunct(x,y,GREEN);
  	x=rangen(0,120);
  	y=rangen(0,160);
  	squarefunct(x,y,PINK);
